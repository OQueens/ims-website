...
export const CALL_RATE_DATA: Record<string, CallRateEntry> = {
  ...
  'neurosurgery': {
    weekday: beeper(4000, 4000, 4000),
    weekend: beeper(4000, 4000, 4000),
    holiday: null,
    callback: { min: 475, max: 475 },
    gratisHrs: 4,
    sources: 2,
    category: 'Surgery',
    note: 'Single-point 24-hr beeper-call posting; 4 gratis hrs then callback applies.',
  },
  'vascular surgery': {
  ...
  'neurology': {
    weekday: worked(1800, 3000, 2400, 10),
    weekend: null,
    holiday: null,
    callback: null,
    gratisHrs: null,
    sources: 1,
    category: 'Medical Specialties',
    note: 'Derived from Aya hourly + fixed 8/12-hr scheduled clinical shifts; no robust modal quote.',
  },
  'otolaryngology': {
    weekday: null, weekend: null, holiday: null, callback: null, gratisHrs: null,
    sources: 0, category: 'Medical Specialties',
